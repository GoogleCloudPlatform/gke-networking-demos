...
resource "google_compute_vpn_tunnel" "vpn1-deployment-tunnel" {
  ...
  depends_on = [google_compute_forwarding_rule.vpn1-deployment-fr-udp4500]
}
...
resource "google_compute_vpn_tunnel" "vpn2-deployment-tunnel" {
  ...
  depends_on = [google_compute_forwarding_rule.vpn2-deployment-fr-udp4500]
}
...
resource "google_compute_vpn_tunnel" "vpn3-deployment-tunnel" {
  ...
  depends_on = [google_compute_forwarding_rule.vpn3-deployment-fr-udp4500]
}
...
resource "google_compute_vpn_tunnel" "vpn4-deployment-tunnel" {
  ...
  depends_on = [google_compute_forwarding_rule.vpn4-deployment-fr-udp4500]
}
